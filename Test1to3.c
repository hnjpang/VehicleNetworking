...
CAN_SYMBOL sendSymbol(bool Symbol, volatile CAN_PORT *can_port_id){
...
// sender code
	...
	if ((newFrameFromSensor==true && BusIdle==true) || (BusIdle==true && Collision==true) || (newFrameFromSensor==true && NoSender==true)){
